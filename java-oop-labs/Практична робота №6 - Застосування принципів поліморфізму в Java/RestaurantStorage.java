...
public class RestaurantStorage {
    private static List<AbstractPerson> allPersons = new ArrayList<>();
    private static List<Employee> allEmployees = new ArrayList<>();
    private static List<Visitor> allVisitors = new ArrayList<>();
    private static List<AbstractRestaurantObject> allRestaurantObjects = new ArrayList<>();
    
    public static void addPerson(AbstractPerson person) {
    ...
    public static void addRestaurantObject(AbstractRestaurantObject obj) {
        allRestaurantObjects.add(obj);
        System.out.println("Додано об'єкт ресторану до сховища: " + obj.getName());
    }
    
    public static List<AbstractPerson> getAllPersons() {
    ...
    public static List<AbstractRestaurantObject> getAllRestaurantObjects() {
