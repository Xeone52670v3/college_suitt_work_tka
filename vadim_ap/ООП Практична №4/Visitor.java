public class Visitor extends Person {
    ...
    public void introduce() {
        System.out.println("Привіт, я відвідувач " + name + ", моя мета: " + visitorGoal);
    }
    
    public void makeReservation(Table table, int guests) {
        if (table.occupyTable(guests)) {
            System.out.println(name + " забронював стіл для " + guests + " гостей");
        }
    }
    ...
    protected boolean isAdult() {
        System.out.println("Перевірка віку для відвідувача " + name);
        return age >= 18;
    }
    ...
    public String toString() {
        return "Відвідувач [ім'я=" + name + ", мета=" + visitorGoal + 
